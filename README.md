**Theme Name:** Twenty Twenty Child for LAWP
**Theme URI:** https://lawp.meanbusiness.com/twentytwenty-lawp-child/
**description:** Twenty Twenty Child Theme for LAWP
**Template:** twentytwentythree
**Version:** 1.0.0
**License:** GNU General Public License v2 or later
**License URI:** http://www.gnu.org/licenses/gpl-2.0.html
**Tags:** accessibility-ready
**Text Domain:** twentytwentylawpchild

#### Child orginally based on [`twentytwenty`](https://github.com/Automattic/twentytwenty/blob/master/README.md) 
